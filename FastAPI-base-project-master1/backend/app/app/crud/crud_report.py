...
from app.crud.media import MixinAttachment


class CRUDReport(CRUDBase[Report, CreatingReport, UpdatingReport], MixinAttachment[Report,ReportImage]):
    ...
    def __init__(self, model: Type[Report],  bucket_name: str | None = None, s3_client=None):
        ...
        self.model_attachment = ReportImage
